...
namespace API.Context
{
    public class StoreContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserBasket>().HasOne(b => b.User).WithMany().HasForeignKey(b => b.UserId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<BasketItem>().HasOne(b => b.User).WithMany().HasForeignKey(b => b.UserId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<BasketItem>().HasOne(b => b.Album).WithMany().HasForeignKey(b => b.AlbumId).OnDelete(DeleteBehavior.Cascade);
        }
